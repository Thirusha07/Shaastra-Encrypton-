...
class AccountFeatures:
    def __init__(self, account_no,
                 ...
                 avg_balance_amount_upper, avg_balance_amount_lower, anomaly_score=None):
...
predictions = best_model.predict(new_transaction[['WITHDRAWAL AMT', 'DEPOSIT AMT', 'BALANCE AMT']])
overall_anomaly_score = predictions.mean()
...
print(f"Overall Anomaly Score: {overall_anomaly_score}")

if overall_anomaly_score < 0:
    print("Overall Anomaly Detected! The transaction is considered an anomaly.")
else:
    print("No Overall Anomaly Detected. The transaction seems normal.")
